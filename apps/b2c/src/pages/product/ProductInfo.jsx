        ...
        <div className="pdp-info">
            ...
            >
                ...
                <button
                    ...
                    style={{
                        borderColor: wished ? "var(--gold)" : "var(--border)",
                        color: wished ? "var(--gold)" : "var(--ink)",
                    }}
                >
            ...
            <div className="pdp-cta" style={{ marginBottom: 30 }}>
                ...
                <a
                    ...
                    className="btn wa-btn btn-lg btn-block"
                    style={{ marginTop: 10 }}
                >
                    WhatsApp Enquiry
                </a>
                ...
                <div>
                    {[
                        [
                            Truck,
                            "Insured Shipping",
                            "Complimentary, fully insured delivery across India.",
                        ],
                        [
                            RefreshCw,
                            "15-Day Returns",
                            "Unworn pieces may be returned within 15 days.",
                        ],
                        [
                            Shield,
                            "Lifetime Warranty",
