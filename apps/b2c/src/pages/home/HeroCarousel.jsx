    ...
    return (
        <section className="c-hero" aria-label="Featured collections">
            ...
            <div
                ...
                style={{
                    background:
                        "linear-gradient(90deg, rgba(8, 22, 47, 0.95) 0%, rgba(8, 22, 47, 0.6) 45%, transparent 100%)",
                }}
            />
            ...
            <div className="c-content">
                <div className="c-inner">
                    <p className="c-eyebrow" key={`ey-${active}`}>
                        {slide.eyebrow}
                    </p>
                    ...
                    <p className="c-sub" key={`s-${active}`}>
                        {slide.sub}
                    </p>
                    ...
                    <div className="c-counter">
                        <span className="c-count-current">
                            {String(active + 1).padStart(2, "0")}
                        </span>
                        <span className="c-count-sep" />
                        <span className="c-count-total">
