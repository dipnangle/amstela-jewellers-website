  ...
  return (
    <section className="hero bg-velvet bg-noise">
      ...
      <div className="hero-grid">
        ...
        <div className="hero-copy" key={`text-${active}`} style={{ animation: 'cFadeUp 0.8s ease both' }}>
          <span className="eyebrow hero-eyebrow">{slide.category} · Since 1999</span>
          ...
          <div className="hero-cta">
            <Link to={slide.href} className="btn btn-champagne btn-lg">
              {slide.cta} <ArrowRight size={16} />
            </Link>
            <Link to="/story" className="btn btn-ghost-white btn-lg">
              Our Story
            </Link>
          </div>
        ...
        <div className="hero-figure" key={`img-${active}`} style={{ 
          animation: 'cFadeInRight 0.8s ease both',
          display: 'flex',
          alignItems: 'center', /* Vertically center as requested */
          justifyContent: 'center',
          position: 'relative',
          border: '1px solid rgba(212,176,106,0.15)', /* Full thin border */
          overflow: 'visible'
        }}>
          <div className="hero-glow-backing" style={{
            position: 'absolute',
            inset: '10%',
          ...
          <span className="hero-frame-corner tc-l" style={{ position: 'absolute', top: -12, left: -12, width: 40, height: 40, borderTop: '2px solid var(--gold)', borderLeft: '2px solid var(--gold)' }} />
          <span className="hero-frame-corner bc-r" style={{ position: 'absolute', bottom: -12, right: -12, width: 40, height: 40, borderBottom: '2px solid var(--gold)', borderRight: '2px solid var(--gold)' }} />
      ...
      {/* Navigation Arrows */}
      <div className="hero-nav-controls" style={{
        position: 'absolute',
        bottom: '40px',
        right: 'var(--gut)',
        display: 'flex',
        ...
        <button onClick={prev} className="nav-ico" style={{ border: '1px solid rgba(255,255,255,0.2)', borderRadius: '50%', width: '44px', height: '44px' }}>
          <ChevronLeft size={20} />
        </button>
        <button onClick={next} className="nav-ico" style={{ border: '1px solid rgba(255,255,255,0.2)', borderRadius: '50%', width: '44px', height: '44px' }}>
