    ...
    <section className="section">
      <div className="wrap">
        <div className="between" style={{ marginBottom: 40 }}>
          ...
          <Link to="/collections" className="link-gold">Shop All</Link>
        </div>
        ...
        <div className="prod-rail">
          {productsData.map(p => {
            ...
            return (
              <div key={p.id} className="prod-card" style={{ width: 300 }}>
                <div className="prod-thumb zoom">
                  <button className={`wish ${wished ? 'on' : ''}`} onClick={() => toggleWish(p)}>
                ...
                <div className="prod-info">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4 }}>
                    ...
                    <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink)' }}>₹{p.price.toLocaleString()}</p>
                  </div>
                </div>
              </div>
            )
