...
export function ShopProvider({ children }) {
  ...
  useEffect(() => localStorage.setItem("amstela_cart", JSON.stringify(cart)), [cart])
  useEffect(() => localStorage.setItem("amstela_wish", JSON.stringify(wish)), [wish])
...
export const useShop = () => {
  ...
  if (!context) {
    ...
    return { 
      cart: [], wish: [], cartCount: 0, cartTotal: 0,
