    ...
    return (
        <footer className="footer">
            <div className="wrap">
                <div className="footer-top">
                    <div className="footer-col footer-brand">
                        ...
                        <p>
                            Surat's premier diamond destination since 1999.
                            Ethically sourced, certified masterpieces crafted
                            for every milestone.
                        </p>
            ...
            <div className="footer-bottom wrap">
                <span>
                    © {new Date().getFullYear()} Amstela Jewels Pvt. Ltd. All
                    rights reserved.
                </span>
