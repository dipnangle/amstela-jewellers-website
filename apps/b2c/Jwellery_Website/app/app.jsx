...
const DARK_HEADER = ["/", "/collections", "/about", "/manufacturing", "/contact"];
...
function Layout({ t, setTweak }) {
  ...
  React.useEffect(() => {
    ...
    const champ = t.accent === "#C9A227" ? "#D4B06A" : t.accent === "#B76E79" ? "#E8C0AE" : "#E2C98A";
  ...
  return (
    <React.Fragment>
      ...
      <Routes>
        <Route path="/" element={<Home heroVariant={t.heroDirection} />} />
