        ...
        <main>
            <div className="page-head bg-velvet">
                ...
                <div className="wrap">
                    ...
                    <p className="lede">
                        Every Amstela piece carries internationally recognised
                        certification — the assurance your buyers demand.
                    </p>
                </div>
            </div>
            ...
            <section className="craft section">
                <div className="wrap on-dark" style={{ textAlign: "center" }}>
                    ...
                    >
                        We provide complete documentation — hallmark
                        certificates, stone grading reports, and export
                        compliance paperwork — for every order.
                    </p>
...
function CertCard({ cert, index }) {
    ...
    return (
        <div
            ref={ref}
            className={`cert-card reveal ${visible ? "in" : ""}`}
            style={{ transitionDelay: `${index * 120}ms` }}
        >
            <div
                className="ic"
                style={{ background: cert.color + "15", borderRadius: "50%" }}
            >
                <span
                    style={{
            ...
            >
                Scope: {cert.scope} · Since {cert.since}
            </p>
        </div>
    );
}
