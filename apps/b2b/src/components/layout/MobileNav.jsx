...
export default function MobileNav({ open, onClose }) {
    ...
    return (
        <>
            ...
            />
            <aside
                className={`fixed top-0 right-0 z-[70] h-full w-80 max-w-full bg-[#0D1527] border-l border-[#243058] transition-transform duration-400 ${open ? "translate-x-0" : "translate-x-full"}`}
            >
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-6 py-4 border-b border-[#243058]">
                        ...
                        <button
                            onClick={onClose}
                            className="p-2 text-[#5A6480] hover:text-white transition-colors"
                        >
                            <X size={20} />
                        </button>
                    </div>
                    ...
                    <div className="px-6 py-4 border-t border-[#243058] space-y-3">
                        <a
                            href={`tel:${SITE.phone}`}
                            className="flex items-center gap-3 text-sm text-[#5A6480] hover:text-[#B8862A] transition-colors"
                        >
                        ...
                        <a
                            ...
                            className="flex items-center gap-3 text-xs text-[#5A6480] hover:text-[#B8862A] transition-colors"
                        >
