    ...
    return (
        <footer className="footer">
            <div className="wrap">
                <div className="footer-top">
                    <div className="footer-col footer-brand">
                        ...
                        <p>
                            Surat's premier diamond manufacturer. Supplying
                            certified, hallmarked jewellery to 40+ export
                            markets worldwide.
                        </p>
            ...
            <div className="footer-bottom wrap">
                ...
                <span>
                    © {new Date().getFullYear()} Amstela Jewels Pvt. Ltd. Export
                    Division.
                </span>
            </div>
        </footer>
